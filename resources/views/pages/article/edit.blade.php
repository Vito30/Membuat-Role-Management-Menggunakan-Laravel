            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('article.update', $article->id) }}">
                        ...
                        <div class="form-group row">
                            <label for="publish" class="col-md-3 col-form-label text-md-right">{{ __('Publish') }}</label>

                            <div class="col-md-7">
                                <select name="publish" id="publish" class="form-control @error('publish') is-invalid @enderror">
                                        <option value="0" {{ $article->publish == 0 ? 'selected' : ''}}>Unpublish</option>
                                        <option value="1" {{ $article->publish == 1 ? 'selected' : ''}}>Publish</option>
                                </select>
